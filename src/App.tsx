  ...
  return (
    <div className="min-h-screen bg-transparent text-neutral-800 flex flex-col font-body selection:bg-primary-500 selection:text-neutral-900">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-20 items-center">
              ...
              <div 
                ...
                className="lg:col-span-6 flex justify-center items-center transition-all duration-500 p-2 sm:p-0 relative"
              >
                ...
                <div className="block lg:hidden relative z-20 w-full flex justify-center mt-12 mb-16 px-4">
                  ...
                  <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none flex items-center justify-center">
                    ...
                    <div className="absolute left-[-10px] sm:left-[5%] top-1/2 -translate-y-1/2 flex items-center z-0 opacity-80">
                      <div className="w-16 sm:w-24 h-1.5 bg-neutral-300/80 rounded-l-full relative overflow-hidden shadow-[inset_0_1px_2px_rgba(0,0,0,0.2)] border border-neutral-400/20">
                        <motion.div 
                          className="absolute inset-y-0 w-10 bg-gradient-to-r from-transparent via-[#25D366] to-transparent"
                          animate={{ x: [-40, 100] }}
                          transition={{ duration: 1.5, repeat: Infinity, ease: "linear" }}
                        />
                      </div>
                      <div className="w-4 h-3.5 bg-neutral-400/90 rounded-sm shadow-md border-r border-neutral-500/30"></div>
                    ...
                    <div className="absolute right-[-10px] sm:right-[5%] top-1/2 -translate-y-1/2 flex items-center flex-row-reverse z-0 opacity-80">
                      <div className="w-16 sm:w-24 h-1.5 bg-neutral-300/80 rounded-r-full relative overflow-hidden shadow-[inset_0_1px_2px_rgba(0,0,0,0.2)] border border-neutral-400/20">
                        <motion.div 
                          className="absolute inset-y-0 w-10 bg-gradient-to-r from-transparent via-[#25D366] to-transparent"
                          animate={{ x: [100, -40] }}
                          transition={{ duration: 1.5, repeat: Infinity, ease: "linear" }}
                      ...
                      <div className="w-4 h-3.5 bg-neutral-400/90 rounded-sm shadow-md border-l border-neutral-500/30"></div>
                      <div className="w-2 h-2.5 bg-neutral-300 border border-neutral-400/50"></div>
                    </div>
                    ...
                    <div className="absolute left-[20%] -bottom-[60px] flex flex-col items-center z-0 opacity-80 rotate-[35deg] origin-top">
                      ...
                      <div className="w-3.5 h-4 bg-neutral-400/90 rounded-sm shadow-md border-b border-neutral-500/30"></div>
                      <div className="w-1.5 h-20 bg-neutral-300/80 rounded-b-full relative overflow-hidden shadow-[inset_0_1px_2px_rgba(0,0,0,0.2)] border border-neutral-400/20">
                        <motion.div 
                          className="absolute inset-x-0 h-10 bg-gradient-to-b from-transparent via-[#25D366] to-transparent"
                          animate={{ y: [80, -40] }}
                  ...
                  >
                    ...
                    <span className="relative z-10 pt-0.5">TRY WA BOT DEMO</span>
                ...
                <motion.div 
                  className="hidden lg:block relative w-full max-w-[340px] mx-auto perspective-1000 group z-10"
                  animate={{ y: [-8, 8, -8] }}
                ...
                >
                  ...
                  <div className="absolute -inset-8 rounded-[70px] border border-white/60 shadow-[0_0_120px_rgba(242,221,52,0.3)] pointer-events-none opacity-90 backdrop-blur-md bg-white/20"></div>
                  
                  {/* Inner ambient glow */}
                  <div className="absolute inset-0 rounded-[64px] bg-[radial-gradient(circle_at_top_left,_rgba(255,255,255,0.8),transparent_50%),radial-gradient(circle_at_bottom_right,_rgba(242,221,52,0.4),transparent_50%)] pointer-events-none blur-xl"></div>
                  ...
                  {/* Phone container */}
                  <div className="relative z-10 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1),0_0_0_1px_rgba(0,0,0,0.05)] rounded-[56px]">
                    <WhatsAppSimulator />
                  </div>
                  ...
                  <motion.div 
                    ...
                    className="absolute -left-16 xl:-left-32 top-24 bg-white/95 border border-neutral-200/80 p-3.5 rounded-2xl shadow-xl shadow-neutral-300/30 max-w-[150px] hidden lg:block z-20 backdrop-blur-xl"
                  >
                  ...
                  <motion.div 
                    ...
                    className="absolute -right-16 xl:-right-32 bottom-28 bg-white/95 border border-neutral-200/80 p-3.5 rounded-2xl shadow-xl shadow-neutral-300/30 max-w-[150px] hidden lg:block z-20 backdrop-blur-xl"
                  >
      ...
      <FeasibilityModal
        ...
        initialPropertyName={modalPreloadName}
        initialEmail={modalPreloadEmail}
      />

  ...
  return (
    <>
      ...
      <main id="top">
        ...
        <section className="testimonial" id="proof">
          <div className="quote-mark reveal">E</div>
          <blockquote className="reveal">
            Ebee lets a society start small, keep every resident in their own bay, and scale charging without creating cable chaos or billing disputes.
          </blockquote>
          <p className="quote-name reveal">Property Operations Team</p>
          <div className="quote-dots" aria-hidden="true"><span></span><span></span><span></span><span></span></div>
        </section>

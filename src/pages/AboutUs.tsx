...
const achievements = [
  "App-less charging through WhatsApp",
  "UPI-native payments with digital receipts",
  "Dynamic load balancing for shared transformers",
  "Centralized Smart DB architecture",
  "Fair usage billing for RWAs and facility teams",
  "Remote monitoring for lower operating effort",
];
...
function useAboutSeo() {
  useEffect(() => {
    ...
    const description =
      "Learn about EbeeCharge, the WBG-backed EV charging company turning building EV mandates into WhatsApp-based, UPI-native customer delight.";
...
function AboutHero({ onRequestAudit }: { onRequestAudit: () => void }) {
  return (
    <section
      id="about-us"
        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-12 lg:gap-16">
          ...
          >
            ...
            <div className="relative mx-auto max-w-[560px]">
              <div className="absolute -left-2 top-10 hidden max-w-[168px] rounded-2xl border border-neutral-200/80 bg-white/95 p-4 shadow-xl shadow-neutral-300/30 backdrop-blur-xl sm:block">
              ...
              <div className="absolute -right-2 bottom-10 hidden max-w-[168px] rounded-2xl border border-neutral-200/80 bg-white/95 p-4 shadow-xl shadow-neutral-300/30 backdrop-blur-xl sm:block">
              ...
              <div className="relative overflow-hidden rounded-[2rem] border border-white/70 bg-[#FEFAF7]/95 p-5 shadow-[0_30px_70px_-30px_rgba(0,0,0,0.18)] backdrop-blur-xl sm:p-8">
                ...
                <div className="relative flex min-h-[170px] items-center justify-center rounded-[1.5rem] p-4 sm:p-6">
                ...
                <div className="relative mt-6 grid grid-cols-3 gap-3 text-center">
                  {[
                    ["32", "points per Smart DB"],
                    ["15", "day rollout lens"],
                    ["0", "apps or wallets"],
                  ].map(([value, label]) => (
                    <div key={label} className="rounded-2xl border border-neutral-200/70 bg-white/80 px-3 py-4 shadow-sm">
...
function CompanyStory() {
  return (
    <section id="company-story" aria-labelledby="company-story-title" className="relative overflow-hidden border-b border-neutral-300 bg-transparent py-16 md:py-28">
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:gap-16">
          <div className="lg:col-span-5">
            <SectionHeader
              ...
              title="A charging company built from the realities of buildings."
              copy="EbeeCharge starts with the property, not the plug. The system is designed around RWAs, developers, facility teams, and residents who need EV readiness without operational drama."
              align="left"
            />
          </div>
          ...
          >
            {[
              ...
              <motion.article
                ...
                className="group rounded-3xl border border-white/60 bg-[#FEFAF7]/95 p-6 shadow-[0_8px_30px_rgba(0,0,0,0.03)] backdrop-blur-xl transition-all duration-300 hover:bg-white hover:shadow-[0_20px_40px_-15px_rgba(242,221,52,0.3)]"
              >
...
function MissionVision() {
  return (
    <section id="mission" aria-labelledby="mission-title" className="relative overflow-hidden border-b border-neutral-300 bg-transparent py-16 md:py-28">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="mb-5 inline-flex items-center gap-2 rounded-full border border-primary-200/60 bg-primary-100/50 px-4 py-2 text-[11px] font-bold uppercase leading-none tracking-widest text-primary-700 shadow-sm backdrop-blur-sm">
            <span className="h-2 w-2 rounded-full bg-primary-500" />
            Mission and vision
          </span>
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={viewport}
          className="relative z-10 mt-10 h-56 overflow-hidden rounded-[2rem] border border-white/70 bg-neutral-900 shadow-[0_30px_70px_-30px_rgba(0,0,0,0.28)] sm:h-72 md:h-80"
        >
          ...
          <div className="absolute bottom-6 left-6 right-6 flex items-center justify-between gap-4 text-white sm:bottom-8 sm:left-8 sm:right-8">
            ...
            <span className="hidden rounded-full border border-white/15 bg-white/10 px-4 py-2 text-[10px] font-black uppercase tracking-widest text-white/80 backdrop-blur sm:inline-flex">
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={viewport}
          className="relative z-10 mt-10 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-14"
        >
...
function WbgLegacy() {
  return (
    <section id="wbg-legacy" aria-labelledby="wbg-title" className="relative overflow-hidden border-b border-neutral-300 bg-transparent py-16 md:py-28">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-12 lg:gap-16">
          <div className="lg:col-span-4">
            <SectionHeader
              eyebrow="WBG legacy"
              title="Engineering heritage behind a consumer-simple experience."
              copy="The front end feels lightweight because the back end is serious: electrical planning, central distribution logic, load safety, billing controls, and remote observability."
              align="left"
            />
          </div>
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={viewport}
            className="relative grid grid-cols-1 gap-4 sm:grid-cols-2 lg:col-span-8"
          >
            {[
              ["Engineering base", "WBG field discipline", ShieldCheck],
              ["Core hardware", "Smart DB and smart sockets", CircuitBoard],
              ["User interface", "WhatsApp plus UPI", Zap],
              ["Operations layer", "Dashboard, billing, analytics", RadioTower],
            ].map(([label, value, Icon], index) => (
              <motion.article
                key={label as string}
                variants={fadeUp}
                className={`rounded-3xl border p-6 shadow-[0_8px_30px_rgba(0,0,0,0.03)] ${
                  index === 0
                    ? "border-neutral-800 bg-neutral-900 text-white"
                    : "border-white/60 bg-[#FEFAF7]/95 text-neutral-900"
                }`}
              >
                <div
                  className={`mb-5 inline-flex h-12 w-12 items-center justify-center rounded-full border ${
                    index === 0 ? "border-white/10 bg-white/10 text-primary-500" : "border-white bg-gradient-to-br from-white to-primary-50 text-primary-600"
                  }`}
                >
...
function TimelineSection() {
  return (
    <section id="timeline" aria-labelledby="timeline-title" className="border-b border-neutral-300 bg-transparent py-16 md:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeader
          eyebrow="Timeline"
          title="How the platform came together."
          copy="The EbeeCharge journey is a series of product decisions that reduce friction for residents while increasing control for property teams."
        />
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-4">
            {timeline.map((item) => (
              <motion.article key={item.title} variants={fadeUp} className="relative md:pl-16">
                ...
                <div className="rounded-3xl border border-white/60 bg-[#FEFAF7]/95 p-6 shadow-[0_8px_30px_rgba(0,0,0,0.03)] backdrop-blur-xl">
...
function GlobalPresence() {
  return (
    <section id="global-presence" aria-labelledby="presence-title" className="relative overflow-hidden border-b border-neutral-300 bg-transparent py-16 md:py-28">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeader
          ...
          title="Regional insight, Indian building focus."
          copy="EbeeCharge combines Southeast Asian operating exposure with a focused Indian EV infrastructure model for societies, developers, authorities, and commercial buildings."
        />
        ...
        >
          {markets.map((market) => (
            <motion.article
              ...
              variants={fadeUp}
              whileHover={{ y: -6, scale: 1.01 }}
              className="rounded-3xl border border-white/60 bg-[#FEFAF7]/95 p-6 shadow-[0_8px_30px_rgba(0,0,0,0.03)] backdrop-blur-xl transition-all duration-300 hover:bg-white hover:shadow-[0_20px_40px_-15px_rgba(242,221,52,0.3)]"
            >
...
function AchievementsLeadership() {
  return (
    <section id="achievements" aria-labelledby="achievements-title" className="border-b border-neutral-300 bg-transparent py-16 md:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:gap-16">
          <div className="lg:col-span-5">
            <SectionHeader
              eyebrow="Achievements"
              title="Designed around the blockers that slow EV adoption."
              copy="EbeeCharge measures progress by practical outcomes: lower friction for residents, lower CAPEX for properties, and lower operating effort for managers."
              align="left"
            />
            ...
            <motion.div
              ...
              whileInView="visible"
              viewport={viewport}
              className="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-1"
            >
          ...
          <div id="leadership" className="lg:col-span-7">
            <SectionHeader
              eyebrow="Team"
              title="A cross-functional team for hardware, software, and operations."
              copy="The leadership model is deliberately integrated because the customer experience depends on the electrical layer, the software layer, and the service layer working together."
              align="left"
            />
            ...
            >
              {leadershipPods.map((pod) => (
                <motion.article
                  key={pod.title}
                  variants={fadeUp}
                  className="rounded-3xl border border-white/60 bg-[#FEFAF7]/95 p-5 shadow-[0_8px_30px_rgba(0,0,0,0.03)] backdrop-blur-xl"
                >
...
function AboutCta({ onRequestAudit }: { onRequestAudit: () => void }) {
  return (
    <section id="about-cta" aria-labelledby="about-cta-title" className="relative overflow-hidden border-b border-neutral-300 bg-transparent py-16 md:py-24">

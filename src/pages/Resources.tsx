...
const featuredResources = [{
  ...
  description: "A practical guide for RWAs to plan EV charging without transformer overload, parking disputes, or app adoption friction.",
  readTime: "8 min read",
  accent: "Smart DB Planning"
}, {
  type: "Blog",
  title: "How WhatsApp + UPI Makes Charging Adoption Easier",
  description: "Why app-less charging works better for mixed-age resident communities and high-traffic visitor parking.",
  readTime: "6 min read",
  accent: "No Apps. No Wallets."
}, {
  type: "FAQ",
  title: "Dynamic Load Balancing, Billing, and Settlements Explained",
  description: "Clear answers for facility teams evaluating fair usage billing, smart metering, and automated RWA settlement flows.",
  readTime: "5 min read",
...
const resources = [{
  ...
  description: "A property-first view of EV compliance, adoption, and the operational details that make charging feel effortless.",
  ...
  description: "Compare centralized distribution, lighter parking ducts, metered sockets, and long-term CAPEX impact.",
  meta: "Infrastructure",
  readTime: "9 min",
  ...
  description: "How automated unit tracking, UPI payments, and transparent logs reduce disputes between EV and non-EV residents.",
  ...
  description: "What to collect before an EV charging feasibility audit: sanctioned load, parking layout, DB room access, and resident demand.",
  meta: "Site Audit",
  readTime: "5 min",
  href: "/resources/ev-guides"
}, {
  ...
  description: "Understand how charging payments, smart metering, and itemized digital logs can be aligned with society accounts.",
  meta: "UPI Native",
  readTime: "4 min",
  href: "/faq"
}, {
  ...
  description: "Answers on socket health, outage alerts, load events, and how centralized monitoring keeps the network reliable.",
...
const faqs = [{
  ...
  answer: "Start with the readiness checklist, then review the Smart DB architecture guide. Together they help your committee understand sanctioned load, parking coverage, resident adoption, and billing responsibilities before a site audit."
}, {
  question: "Are the guides written for technical or non-technical teams?",
  answer: "They are written for mixed committees. Each guide keeps engineering context clear enough for facility teams while explaining decision points in plain language for RWAs, developers, and finance teams."
}, {
  question: "Can Ebee customize a resource for our property?",
  answer: "Yes. After a site feasibility audit, Ebee can map the recommendations to your parking layout, electrical room constraints, sanctioned load, resident demand, and billing workflow."
}];
export default function Resources() {
  ...
  useEffect(() => {
    ...
    const description = "Explore EbeeCharge EV charging blogs, guides, FAQs, downloads, and checklists for residential societies, developers, RWAs, and facility teams.";
  ...
  const filteredResources = useMemo(() => {
    ...
    return resources.filter(resource => {
      ...
      const matchesSearch = !query || resource.title.toLowerCase().includes(query) || resource.description.toLowerCase().includes(query) || resource.meta.toLowerCase().includes(query);
      ...
      <main className="flex-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
              ...
              duration: 0.5
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-2 sm:items-center sm:justify-center lg:justify-start">
                  <motion.a href="#featured-content" whileHover={{
                  scale: 1.02,
                  y: -2
                }} whileTap={{
                  scale: 0.98
              ...
              delay: 0.1
                ...
                <div className="relative -[32px] border border-white/70 bg-white/80 p-4 sm:p-5 shadow-[0_30px_80px_-30px_rgba(0,0,0,0.25)] backdrop-blur-xl">
                  ...
                  <div className="relative space-y-3">
                    {featuredResources.map((resource, index) => <motion.article key={resource.title} initial={{
                    opacity: 0,
                    x: 16
                  }} animate={{
                    opacity: 1,
                  ...
                  }} className="border border-neutral-200/70 bg-neutral-200/70 p-4 transition-all duration-300 hover:border-primary-300 hover:bg-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-5 items-center">
              <label className="relative block">
                ...
                <input value={searchQuery} onChange={event => setSearchQuery(event.target.value)} placeholder="Search guides, billing, WhatsApp, Smart DB, site audit..." className="w-full border border-neutral-200 bg-white py-4 pl-12 pr-4 text-sm font-semibold text-neutral-900 placeholder:text-neutral-400 shadow-sm outline-none transition-all focus:border-primary-400 focus:ring-4 focus:ring-primary-500/15" />
              </label>
              ...
              <div className="flex gap-2 overflow-x-auto pb-1 lg:pb-0">
                ...
                return <button key={category.value} type="button" onClick={() => setActiveCategory(category.value)} className={`inline-flex shrink-0 items-center gap-2 rounded-full px-4 py-3 text-[12px] font-black uppercase tracking-wider transition-all ${isActive ? "bg-neutral-900 text-primary-500 shadow-lg shadow-neutral-900/15" : "border border-neutral-200 bg-white text-neutral-600 hover:border-primary-300 hover:text-neutral-900"}`}>
        ...
        <section id="featured-content" className="py-20 bg-transparent border-b border-neutral-300">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              once: true
            }} className="group border border-neutral-200/60 bg-neutral-50 p-6 transition-all duration-300 hover:-translate-y-1 hover:border-primary-300 hover:bg-white hover:shadow-xl hover:shadow-neutral-300/30">
                  <div className="mb-8 flex items-center justify-between">
                    <span className="bg-white px-3 py-1.5 text-[10px] font-black uppercase tracking-wider text-primary-600 shadow-sm">
                      {resource.type}
                    </span>
        ...
        <section id="resource-grid" className="py-20 bg-neutral-50 border-b border-neutral-200/50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredResources.map((resource, index) => <Link key={resource.title} to={resource.href} className="block h-full">
                ...
                once: true
              }} className="group h-full border border-neutral-200/60 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-primary-300 hover:shadow-xl hover:shadow-neutral-300/30">
                    <div className="flex items-center justify-between gap-4">
                      <span className="bg-neutral-100 px-3 py-1.5 text-[10px] font-black uppercase tracking-wider text-neutral-600">
                        {resource.label}
                      </span>
                      <span className="inline-flex items-center gap-1.5 text-[11px] font-bold text-neutral-500">
            ...
            {filteredResources.length === 0 && <div className="border border-neutral-200 bg-white p-10 text-center">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
              ...
              <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-3 gap-5">
                {downloads.map((download, index) => <motion.article key={download.title} initial={{
                opacity: 0,
                y: 18
              }} whileInView={{
                opacity: 1,
                ...
                once: true
              }} className="border border-neutral-200/60 bg-neutral-50 p-5 transition-all duration-300 hover:border-primary-300 hover:bg-white hover:shadow-lg">
                    <div className="mb-5 flex h-12 w-12 items-center justify-center bg-primary-100 text-primary-600">
        ...
        <section id="resource-faq" className="py-20 bg-neutral-50 border-b border-neutral-200/50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-4">
              ...
              return <div key={faq.question} className="bg-white border border-neutral-200/50 overflow-hidden transition-all duration-300">
                    <button type="button" onClick={() => setOpenFaq(isOpen ? null : index)} className="w-full text-left p-5 flex justify-between items-center gap-4 text-neutral-900 font-extrabold text-sm tracking-tight focus:outline-none">
                      <span>{faq.question}</span>
                      <span className="shrink-0 p-1 bg-neutral-50 border border-neutral-200 text-primary-500">
                        {isOpen ? <Minus className="w-3.5 h-3.5" /> : <Plus className="w-3.5 h-3.5" />}
                      </span>
                    </button>

                    {isOpen && <div className="px-5 pb-5 pt-1 text-neutral-500 text-[12px] leading-relaxed font-body font-normal border-t border-neutral-200/30">
                        {faq.answer}
                      </div>}
                  </div>;
            })}
        ...
        <section className="py-16 bg-gradient-to-r from-primary-500 via-primary-400 to-primary-500 border-b border-primary-600/30 font-body relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <div className="mx-auto mb-5 flex h-12 w-12 items-center justify-center bg-neutral-950/10 text-neutral-950">
            ...
            <motion.button type="button" onClick={handleOpenAudit} whileHover={{
            scale: 1.05,
            y: -2
          }} whileTap={{
            scale: 0.95

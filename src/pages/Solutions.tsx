...
const audiences = [{
  ...
  summary: "Pre-wire projects with basic sockets and centralized intelligence, instead of loading every bay with expensive smart chargers.",
  ...
  summary: "Residents charge in their own assigned slots while the society gets clean billing, controlled access, and safer electrical management.",
  ...
  summary: "The driver parks, plugs in, scans the socket QR, pays by UPI, and gets a digital receipt in WhatsApp.",
...
const stats = [{
  value: "20%",
  label: "EV-ready parking mandate target",
  detail: "2W and 4W parking readiness"
}, {
  value: ">95%",
  label: "charging happens at home",
  detail: "from Ebee's market context"
}, {
  value: "32",
  label: "AC sockets per Smart DB",
  detail: "central control from one unit"
}, {
  value: "15",
  label: "day audit to installation roadmap",
  detail: "site study to live handoff"
}];
const benefits = ["Residents charge in their assigned parking slots instead of queuing for shared chargers.", "Societies avoid manual collections because sessions are prepaid through UPI.", "Developers can make every bay EV-ready with centralized intelligence and simple endpoints.", "Facility teams get safer scaling through load limits, thermal checks, and controlled socket access.", "Properties can start small and add bays as EV adoption grows.", "Poor basement connectivity stops being a per-bay blocker because the DB carries the connection."];
const proofPoints = [{
...
function SectionHeader({
  ...
  return <motion.div initial="hidden" whileInView="visible" viewport={{
    once: true,
    margin: "-80px"
  }} variants={fadeUp} className={`max-w-3xl ${align === "center" ? "mx-auto text-center" : "text-left"}`}>
      <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary-100/50 border border-primary-200/50 backdrop-blur-sm mb-5 shadow-sm">
...
export function SolutionsPage() {
  ...
  useEffect(() => {
    ...
    const description = "EbeeCharge solutions for developers, RWAs, government authorities, and EV users using Smart DB, WhatsApp charging, UPI payments, and dynamic load balancing.";
  ...
  return <div className="min-h-screen bg-transparent text-neutral-800 flex flex-col font-body selection:bg-primary-500 selection:text-neutral-900">
      ...
      <main className="flex-1">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <motion.div initial="hidden" animate="visible" variants={stagger} className="flex flex-col items-center">
            <motion.div variants={fadeUp} className="inline-flex items-center gap-2 px-4 py-2 bg-white/70 border border-white/60 backdrop-blur-xl shadow-sm mb-8">
            ...
            {/* THE FIGURE */}
            <motion.div variants={fadeUp} className="relative w-full max-w-2xl mx-auto mb-16 mt-8">
              ...
              {/* Floating Background Bubbles (Keywords) */}
              <motion.div className="hidden lg:flex absolute -top-12 -left-36 z-0 flex-col justify-center items-center gap-3 rounded-full bg-white/80 backdrop-blur-md border border-white/90 shadow-[0_15px_40px_rgb(0,0,0,0.08)] w-48 h-48 p-4 text-center" animate={{
                y: [0, -15, 0]
              }} transition={{
                duration: 5,
                repeat: Infinity,
                ...
                <div className="bg-primary-100 p-3 rounded-full"><MessageSquare className="w-6 h-6 text-primary-700" /></div>
                <span className="text-xs font-black uppercase tracking-widest text-neutral-900 leading-snug">WhatsApp<br />Charging</span>
              </motion.div>
              
              <motion.div className="hidden lg:flex absolute top-16 -right-36 z-0 flex-col justify-center items-center gap-3 rounded-full bg-white/80 backdrop-blur-md border border-white/90 shadow-[0_15px_40px_rgb(0,0,0,0.08)] w-48 h-48 p-4 text-center" animate={{
                y: [0, 15, 0]
              }} transition={{
                duration: 6,
                repeat: Infinity,
                ...
                <div className="bg-neutral-900 p-3 rounded-full"><CircuitBoard className="w-6 h-6 text-primary-500" /></div>
                <span className="text-xs font-black uppercase tracking-widest text-neutral-900 leading-snug">Smart DB<br />Infrastructure</span>
              </motion.div>

              <motion.div className="hidden lg:flex absolute bottom-32 -left-40 z-0 flex-col justify-center items-center gap-3 rounded-full bg-white/80 backdrop-blur-md border border-white/90 shadow-[0_15px_40px_rgb(0,0,0,0.08)] w-48 h-48 p-4 text-center" animate={{
                y: [0, -12, 0]
              }} transition={{
                duration: 5.5,
                repeat: Infinity,
                ...
                <div className="bg-primary-100 p-3 rounded-full"><ReceiptIndianRupee className="w-6 h-6 text-primary-700" /></div>
                <span className="text-xs font-black uppercase tracking-widest text-neutral-900 leading-snug">UPI<br />Payments</span>
              </motion.div>

              <motion.div className="hidden lg:flex absolute -bottom-10 -right-36 z-0 flex-col justify-center items-center gap-3 rounded-full bg-white/80 backdrop-blur-md border border-white/90 shadow-[0_15px_40px_rgb(0,0,0,0.08)] w-48 h-48 p-4 text-center" animate={{
                y: [0, 12, 0]
              }} transition={{
                duration: 4.5,
                repeat: Infinity,
                ...
                <div className="bg-neutral-900 p-3 rounded-full"><Gauge className="w-6 h-6 text-primary-500" /></div>
                <span className="text-[10px] font-black uppercase tracking-widest text-neutral-900 leading-snug">Intelligent<br />Load<br />Management</span>
              </motion.div>

              <div className="relative z-10 overflow-hidden -[2rem] sm:-[3rem] border border-white/70 bg-[#FEFAF7]/95 p-4 sm:p-6 shadow-[0_34px_90px_-38px_rgba(23,23,20,0.55)] backdrop-blur-xl text-left">
                ...
                <div className="relative flex items-center justify-between gap-4 border border-white/70 bg-white/85 p-4 shadow-[0_18px_50px_-28px_rgba(23,23,20,0.45)]">
                  <div>
                  ...
                  <div className="flex h-14 w-14 shrink-0 items-center justify-center bg-neutral-900 text-primary-500 shadow-xl shadow-neutral-900/20">
                    <CircuitBoard className="h-7 w-7" />
                  </div>
                </div>

                <div className="relative mt-5 -[2rem] border border-neutral-200/70 bg-white/55 p-4 shadow-inner">
                  <div className="absolute left-1/2 top-8 bottom-8 w-px bg-primary-300/60" />
                  <motion.div className="absolute left-1/2 top-8 h-24 w-px bg-gradient-to-b from-transparent via-primary-500 to-transparent" animate={{
                    y: [0, 210, 0]
                  }} transition={{
                    duration: 4,
                    repeat: Infinity,
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {[["A-14", "RWA", true], ["A-15", "Developer", true], ["B-03", "Resident", true], ["B-04", "Ready", false], ["C-18", "UPI paid", true], ["C-19", "Available", false]].map(([bay, tag, active], index) => <motion.div key={bay} initial={{
                      opacity: 0,
                      y: 14
                    }} animate={{
                      opacity: 1,
                      ...
                      ease: "easeOut"
                    }} className={`relative min-h-[76px]  border p-3 shadow-sm ${active ? "border-primary-200 bg-primary-50/80" : "border-white/70 bg-white/80"}`}>
                  ...
                  <motion.div className="absolute left-1/2 top-1/2 z-10 flex h-28 w-28 -translate-x-1/2 -translate-y-1/2 flex-col items-center justify-center -[2rem] border border-primary-300/60 bg-neutral-900 text-center text-primary-500 shadow-2xl shadow-neutral-900/30" animate={{
                    y: [-3, 3, -3]
                  }} transition={{
                    duration: 4,
                    repeat: Infinity,
                ...
                <div className="relative mt-4 grid grid-cols-3 gap-3">
                  {[{
                    ...
                    return <motion.div key={item.label} initial={{
                      ...
                      ease: "easeOut"
                    }} className="border border-white/70 bg-white/85 p-3 text-center shadow-sm">
            ...
            {/* THE 3 BOXES */}
            <motion.div variants={fadeUp} className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-4xl w-full mb-12">
              {[["20%", "EV-ready mandate"], ["6", "bays per Smart DB"], ["No app", "WhatsApp + UPI"]].map(([value, label]) => <div key={label} className="border border-white/70 bg-white/65 px-6 py-5 shadow-sm backdrop-blur-xl text-center">
                  <div className="text-2xl sm:text-3xl font-black tracking-tight text-neutral-900 font-display">{value}</div>
                  <div className="mt-2 text-[11px] sm:text-xs font-bold leading-tight text-neutral-500 uppercase tracking-widest">{label}</div>
                </div>)}
            </motion.div>

            {/* THE AUDIT BUTTON */}
            <motion.div variants={fadeUp} className="flex justify-center w-full max-w-md">
              <motion.button onClick={handleOpenAudit} whileHover={{
                scale: 1.02,
                y: -2
              }} whileTap={{
                scale: 0.98
      ...
      <section id="audiences" className="relative scroll-mt-32 py-14 md:py-28 border-b border-neutral-300 bg-transparent overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader eyebrow="Stakeholder portals" title="Built for the people who approve, operate, and use charging." description="Each audience gets the same low-friction infrastructure, tuned to the decision that matters most to them." />
          <div className="mt-10 md:mt-16 grid grid-cols-1 md:grid-cols-3 gap-5 items-stretch">
            {audiences.map((audience, index) => {
              const Icon = audience.icon;
              return <motion.article id={audience.id} key={audience.id} initial={{
                opacity: 0,
                y: 28
              }} whileInView={{
                opacity: 1,
                ...
                ease: "easeOut",
                delay: index * 0.06
              }} className="group relative scroll-mt-32 overflow-hidden -[2rem] border border-white/70 bg-[#FEFAF7]/95 p-6 shadow-[0_8px_30px_rgba(0,0,0,0.035)] transition-all duration-300 hover:-translate-y-1 hover:bg-white hover:shadow-[0_24px_60px_-30px_rgba(23,23,20,0.35)]">
                  ...
                  <div className="relative flex h-full flex-col gap-5">
                    ...
                    <div className="flex h-full flex-col">
                      ...
                      <ul className="mt-auto pt-5 grid grid-cols-1 gap-2.5">
                        {audience.bullets.map(bullet => <li key={bullet} className="flex items-start gap-2 text-xs font-bold leading-snug text-neutral-700">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
            <div className="lg:col-span-5">
              <SectionHeader align="left" eyebrow="Benefits" title="Lower admin, lower CAPEX, better resident experience." description="The core promise stays simple: make EV readiness easier to approve, easier to operate, and easier to use." />
            </div>
            <motion.div initial="hidden" whileInView="visible" viewport={{
              once: true,
              margin: "-80px"
            }} variants={stagger} className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              {benefits.map(benefit => <motion.div key={benefit} variants={fadeUp} className="flex items-start gap-3 border border-white/70 bg-white/75 p-5 shadow-[0_8px_30px_rgba(0,0,0,0.035)] backdrop-blur-xl">
      ...
      <section className="relative py-14 md:py-28 border-b border-neutral-300 bg-transparent overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <SectionHeader eyebrow="Deployment proof" title="Built around real property deployment patterns." description="The page avoids invented case-study names and instead uses the deployment contexts documented in Ebee's company material." />
          <motion.div initial="hidden" whileInView="visible" viewport={{
            once: true,
            margin: "-80px"
          }} variants={stagger} className="mt-10 md:mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
            {proofPoints.map(point => <motion.article key={point.title} variants={fadeUp} className="bg-[#FEFAF7]/95 border border-white/60 p-6 shadow-[0_8px_30px_rgba(0,0,0,0.035)] transition-all duration-300 hover:-translate-y-1 hover:bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            <motion.div initial={{
              ...
              <SectionHeader align="left" eyebrow="Operating model" title="A cleaner architecture for AC and DC charging." description="Use Smart DB based AC charging for everyday home charging, then add movable DC charging where fast top-ups need to reach any bay." />
            </motion.div>
            <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-5">
              {[{
                ...
                return <motion.article key={item.title} initial={{
                  ...
                  duration: 0.7,
                  ease: "easeOut"
                }} className="bg-white/80 border border-white/70 p-6 shadow-[0_8px_30px_rgba(0,0,0,0.04)] backdrop-blur-xl">
      ...
      <section className="py-14 md:py-24 bg-transparent border-b border-neutral-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-5">
            {stats.map(stat => <motion.div key={stat.label} initial={{
              opacity: 0,
              y: 20
            }} whileInView={{
              opacity: 1,
              ...
              duration: 0.7,
              ease: "easeOut"
            }} className="border border-white/70 bg-[#FEFAF7]/90 p-5 sm:p-6 text-center shadow-[0_8px_30px_rgba(0,0,0,0.035)]">
      ...
      <section className="relative py-14 md:py-28 border-b border-neutral-300 bg-transparent overflow-hidden">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader eyebrow="Society meeting FAQ" title="The objections your committee will ask first." description="Short answers for the practical questions that decide whether a charging proposal moves forward." />
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-4">
            {faqs.map(faq => <motion.article key={faq.q} initial={{
              opacity: 0,
              y: 24
            }} whileInView={{
              opacity: 1,
              ...
              duration: 0.7,
              ease: "easeOut"
            }} className="bg-white/80 border border-white/70 p-6 shadow-[0_8px_30px_rgba(0,0,0,0.04)]">
      ...
      <section className="relative py-16 md:py-24 bg-transparent overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <motion.div initial={{
            ...
            duration: 0.75,
            ease: "easeOut"
          }} className="-[2rem] sm:-[3rem] border border-white/70 bg-[#FEFAF7]/90 p-8 sm:p-12 shadow-[0_30px_80px_-45px_rgba(23,23,20,0.45)] backdrop-blur-xl">

...
export function FeasibilityModal({ isOpen, onClose, initialPropertyName = "", initialEmail = "" }: FeasibilityModalProps) {
  ...
  const loadingSteps = [
    "Analyzing property size & parking geometry...",
    "Querying smart grid requirements & municipal bylaws...",
    "Calculating load-balancing power curves for your building...",
    "Estimating CAPEX delta against legacy layouts...",
    "Assembling unified ebee Smart DB engineering blueprint..."
  ];
  ...
  return (
    <div className="fixed inset-0 bg-neutral-200/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
      <div 
        className={`bg-neutral-200 border border-neutral-300 rounded-3xl w-full max-w-4xl shadow-2xl shadow-neutral-300/50 overflow-hidden transition-all duration-300 relative ${
          report ? "max-h-[90vh] flex flex-col" : "max-h-none"
        }`}
        id="printable-feasibility-report"
      >
        {/* Header Ribbon */}
        <div className="bg-gradient-to-r from-[#e8a317]/20 via-primary-500/10 to-[#232427] px-6 py-4 flex justify-between items-center border-b border-neutral-300/80 shrink-0">
          <div className="flex items-center gap-2">
            <span className="w-8 h-8 rounded-lg bg-primary-500 font-bold text-neutral-900 border border-neutral-700/80 text-sm flex justify-center items-center tracking-tighter">
              eb
            </span>
            <div>
              <h3 className="text-sm font-bold tracking-tight text-neutral-800 flex items-center gap-1.5 font-body">
                ebee AI Feasibility Suite <span className="text-[10px] bg-primary-500/20 text-primary-400 font-mono font-semibold px-2 py-0.5 rounded-full">v1.4 India</span>
              </h3>
          ...
          <button 
            type="button" 
            onClick={onClose} 
            className="text-neutral-500 hover:text-neutral-800 hover:bg-neutral-800 p-1.5 rounded-full transition-colors print:hidden"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-4 md:p-8 overflow-y-auto flex-1">
          {error && (
            <div className="mb-4 md:mb-6 bg-red-600/10 border border-red-500/30 rounded-xl p-4 text-xs font-mono text-red-400 flex items-center gap-2">
          ...
          {!report && !loading ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-5 pt-2">
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    placeholder="e.g. Parkwood Apartments Association"
                    className="w-full bg-neutral-200 border border-neutral-300 focus:border-primary-500 rounded-lg md:rounded-xl text-neutral-800 px-3 py-2 md:px-4 md:py-2.5 text-xs md:text-sm outline-none transition"
                  />
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    placeholder="e.g. secretary@parkwoodrwa.in"
                    className="w-full bg-neutral-200 border border-neutral-300 focus:border-primary-500 rounded-lg md:rounded-xl text-neutral-800 px-3 py-2 md:px-4 md:py-2.5 text-xs md:text-sm outline-none transition"
                  />
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    placeholder="e.g. 150 kVA available, or Unknown"
                    className="w-full bg-neutral-200 border border-neutral-300 focus:border-primary-500 rounded-lg md:rounded-xl text-neutral-800 px-3 py-2 md:px-4 md:py-2.5 text-xs md:text-sm outline-none transition"
                  />
              ...
              <div className="pt-2 md:pt-4 border-t border-neutral-300/60 flex justify-end">
                <button
                  type="submit"
                  className="px-6 py-3 bg-primary-500 font-bold text-neutral-950 text-sm rounded-xl tracking-tight hover:bg-primary-400 active:scale-95 transition-all text-center flex items-center gap-2"
                >
            ...
            /* Generated PDF-style Report Presentation */
            <div className="space-y-6 text-neutral-800 text-left font-body">
              
              {/* Proposal Header Banner */}
              <div className="bg-gradient-to-br from-neutral-900 to-[#122e31]/30 p-5 rounded-2xl border border-neutral-300 relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {/* Gauge Score */}
                <div className="bg-neutral-200/80 backdrop-blur-sm p-4 rounded-xl border border-neutral-300/80 flex flex-col justify-center items-center text-center">
                  ...
                  <div className="relative flex items-center justify-center">
                    <svg className="w-24 h-24 transform -rotate-90">
                      ...
                      <circle 
                        ...
                        strokeDashoffset={2 * Math.PI * 40 * (1 - (report?.feasibilityScore || 90) / 100)}
                      />
                    </svg>
                ...
                <div className="bg-neutral-200/80 backdrop-blur-sm p-4 rounded-xl border border-neutral-300/80 flex flex-col justify-center">
              ...
              {/* Tabs selector */}
              <div className="flex border-b border-neutral-300 gap-1 inline-flex p-1 bg-neutral-200 rounded-lg w-full print:hidden">
                <button
                  type="button"
                  onClick={() => setActiveTab("tech")}
                  className={`flex-1 flex justify-center items-center gap-2 py-2 px-3 text-xs font-bold rounded-md transition-all ${
                    activeTab === "tech" ? "bg-primary-500 text-neutral-950" : "text-neutral-500 hover:text-neutral-800"
                  }`}
                >
                ...
                <button
                  ...
                  className={`flex-1 flex justify-center items-center gap-2 py-2 px-3 text-xs font-bold rounded-md transition-all ${
                    activeTab === "fin" ? "bg-primary-500 text-neutral-950" : "text-neutral-500 hover:text-neutral-800"
                  }`}
                >
                ...
                <button
                  ...
                  className={`flex-1 flex justify-center items-center gap-2 py-2 px-3 text-xs font-bold rounded-md transition-all ${
                    activeTab === "map" ? "bg-primary-500 text-neutral-950" : "text-neutral-500 hover:text-neutral-800"
                  }`}
                >
              ...
              {activeTab === "tech" && report && (
                <div className="space-y-4 pt-1 transition-all">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-neutral-200 p-4 rounded-xl border border-neutral-300 space-y-2">
                  ...
                  <div className="bg-primary-950/20 border border-primary-900/30 p-4 rounded-xl space-y-1">
                    <span className="text-[10px] bg-primary-500/20 text-primary-400 px-2 py-0.5 rounded font-mono font-semibold uppercase">
              ...
              {activeTab === "fin" && report && (
                <div className="space-y-4 pt-1 transition-all">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {/* Traditional Block */}
                    <div className="bg-neutral-200 p-4 rounded-xl border border-neutral-300 space-y-3 opacity-75">
                      <h5 className="text-xs font-bold text-neutral-500 uppercase tracking-widest flex justify-between items-center">
                        ...
                        <span className="text-[10px] bg-red-950 text-red-400 px-2 py-0.5 rounded font-body">High cost</span>
                      </h5>
                    ...
                    <div className="bg-[#12241d] p-4 rounded-xl border border-primary-900/40 space-y-3 relative overflow-hidden">
                      {/* Huge gold savings indicator */}
                      <div className="absolute top-3 right-3 bg-primary-500 text-neutral-950 font-extrabold text-[10px] px-2.5 py-0.5 rounded-full font-body tracking-tight">
                  ...
                  <div className="bg-neutral-200/50 p-3.5 rounded-xl border border-neutral-300/60 grid grid-cols-2 gap-4 text-center">
                    <div>
              ...
              {activeTab === "map" && report && (
                <div className="space-y-4 pt-1 transition-all">
                  <div className="bg-neutral-200 border border-neutral-300/80 rounded-xl overflow-hidden">
                    ...
                    <div className="divide-y divide-neutral-800/60 text-xs">
                      {report.implementationRoadmap.map((step, idx) => (
                        <div key={idx} className="p-4 grid grid-cols-12 gap-2 tracking-wide font-body font-normal hover:bg-neutral-200/20 transition-colors">
              ...
              <div className="border-t border-neutral-300/60 pt-5 flex flex-wrap gap-3 justify-end print:hidden">
                <button
                  ...
                  className="px-4 py-2 border border-neutral-300 rounded-xl text-xs hover:bg-neutral-200 transition tracking-tight"
                >
                ...
                <button
                  type="button"
                  onClick={handlePrint}
                  className="px-4 py-2 bg-neutral-200 hover:bg-neutral-800 text-[#e8a317] border border-[#e8a317]/20 font-bold rounded-xl text-xs tracking-tight flex items-center gap-1.5 transition-all active:scale-95"
                >
                ...
                <button
                  type="button"
                  onClick={onClose}
                  className="px-5 py-2 bg-primary-500 text-neutral-950 font-bold rounded-xl text-xs tracking-tight transition hover:bg-primary-400 active:scale-95"
                >
